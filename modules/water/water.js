...
(function() {
  ...
  function renderWater() {
    ...
    else if (pctRaw < 130) { helper.innerHTML = '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:1em;height:1em;vertical-align:-0.14em;display:inline-block" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg> Target hit — top up if you train this evening.'; helper.classList.add('good'); }
